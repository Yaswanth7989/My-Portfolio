...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document
    .getElementById("btn primary-btn")
    .addEventListener("click", function () {
      // Create a hidden anchor element
      const link = document.createElement("a");
      link.href = "E:Naveen assigmentstep_p0Yaswanth's Resume"; // Replace with your CV's path
  ...
  function fadeInElements() {
    const elements = document.querySelectorAll(
      ".hero-content, .hero-image, .section-header, .about-content, .skills-content, .projects-grid, .contact-content"
    );
  ...
  function handleImageError(img) {
    ...
    img.onerror = function () {
      ...
      this.src =
        "data:image/svg+xml;charset=utf-8,%3Csvg xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22 width%3D%22100%25%22 height%3D%22100%25%22 fill%3D%22%23" +
        pastelColor.replace("#", "") +
        "%22%3E%3Crect width%3D%22100%25%22 height%3D%22100%25%22%2F%3E%3C%2Fsvg%3E";
